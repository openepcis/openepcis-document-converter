...
public class ContextHandlerTest {
  ...
  void jsonToXmlTest() throws Exception {
    final InputStream inputStream =
        getClass().getResourceAsStream("/1. GS1_Eg_EPCIS_Document.json");
  ...
  void jsonToXmlWithMapperTest() throws Exception {
    final InputStream inputStream =
        getClass().getResourceAsStream("/2. GS1_Eg_EPCIS_Document.json");
    final FormatPreference withWebURI =
        new FormatPreference("always_gs1_digital_link", "always_web_uri");
    final BiFunction<Object, List<Object>, Object> mapper =
        GS1FormatSupport.createMapper(withWebURI);
    final Conversion conversion =
        Conversion.builder()
            .fromMediaType(EPCISFormat.JSON_LD)
            .fromVersion(EPCISVersion.VERSION_2_0_0)
