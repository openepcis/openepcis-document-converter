...
import io.openepcis.epc.formatconverter.JsonToXmlConverter;
...
import io.openepcis.epc.formatconverter.outputhandler.EventXMLStreamCollector;
...
public class JsonToXmlTest {
  ...
  public void jsonToXmlTest() throws Exception {
    final InputStream jsonStream = getClass().getResourceAsStream("/InputEPCISEvents.json");
  ...
  public void jsonToXmlTestSingleEvent() throws Exception {
    final InputStream jsonStream = getClass().getResourceAsStream("/InputEpcisSingleEvent.json");
    final ByteArrayOutputStream out = new ByteArrayOutputStream();
